...
modulos="etapaflops1 etapaflops2 recirculacion mux4x2_8bits mux2x1_8bits paralelo_serial1 serial_paralelo1 paralelo_serial2 serial_paralelo2 demux1x2_8bits demux2x4_8bits etapaflops3 phy_rx phy_tx "$1
### echo $modulos
for i in $modulos; do
