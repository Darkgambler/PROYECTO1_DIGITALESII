...
(* top =  1  *)
(* src = "synth_PRX.v:13" *)
module synth_PRX(data_rx000_synt, valid_rx000_synt, active_synt, data_0rp_synt, data_1rp_synt, data_2rp_synt, data_3rp_synt, valid_0rp_synt, valid_1rp_synt, valid_2rp_synt, valid_3rp_synt, data_0p, data_1p, data_2p, data_3p, valid_0p, valid_1p, IDLE_OUT_synt, clk_4f, valid_2p, valid_3p, clk_f, clk_2f, clk_32f, reset);
  (* src = "synth_PRX.v:22" *)
  input IDLE_OUT_synt;
  (* src = "synth_PRX.v:14" *)
  output active_synt;
